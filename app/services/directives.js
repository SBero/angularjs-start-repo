(function() {
    ...
    app.directive('ccScrollToTop', ['$window',
        ...
        function ($window) {
            var directive = {
                link: link,
                template: '<a href="#"><i class="glyphicon glyphicon-chevron-up"></i></a>',
                restrict: 'A'
            };
            return directive;
    ...
    app.directive('ccWidgetHeader', function() {
        ...
        function link(scope, element, attrs) {
            attrs.$set('class', 'jumbotron');
        }
    });

    app.directive('ccBack', ['$window', function($window){
        //Usage:
        //<div data-cc-back></div>
        var directive = {
            restrict: 'A',
            template: '<a class="btn btn-default">Back</a>',
            link: link
        }
